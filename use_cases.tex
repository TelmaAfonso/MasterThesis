...
Heading back to the \textit{Data Visualization} page the effects of the applied preprocessing methods are noticeable (\autoref{propolis_data_overview_preproc}).
